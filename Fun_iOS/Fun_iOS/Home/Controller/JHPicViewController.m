...
#import "JHPicViewController.h"
#import "JHGifCell.h"
#import "customLayout.h"
#import "VideoItem.h"

@interface JHPicViewController ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@implementation JHPicViewController

static NSString * const reuseIdentifier = @"JHGifCell";
...
- (void)loadNewData{
    ...
    NSString *url = [NSString stringWithFormat:@"%@%@",SERVER_HOST,API_Gif];
    //接收参数类型
    ...
    [manager GET:url parameters:paramer progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        ...
        NSArray *newData = [GifItem mj_objectArrayWithKeyValuesArray:responseObject[@"items"]];
...
- (void)loadOldData{
    ...
    [manager GET:url parameters:paramer progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        ...
        NSArray *oldData = [GifItem mj_objectArrayWithKeyValuesArray:responseObject[@"items"]];
...
- (void)setupDefault{
    ...
    [collectionView registerNib:[UINib nibWithNibName:NSStringFromClass([JHGifCell class]) bundle:nil] forCellWithReuseIdentifier:reuseIdentifier];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    JHGifCell *cell = (JHGifCell *)[collectionView dequeueReusableCellWithReuseIdentifier:reuseIdentifier forIndexPath:indexPath];
